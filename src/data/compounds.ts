...
export const products: Product[] = [
  {
    id: 'DSG-MD',
    name: 'Dosage — Mystery Dispense [PRE-ORDER]',
    description: 'FIRST EDITION PRE-ORDER — Limited to 250 units. Each dose contains one randomly assigned compound from the current batch. Contents remain unknown until opened. Current batch may include black, blue, pink, white/orange, and hand-painted variants. Outcomes are not selectable and probability is not uniform. Pre-order ends June 13. Orders will be shipped by June 20.',
    ...
    doses: [
      {
        id: 'd-mystery',
        productId: 'DSG-MD',
        title: 'Mystery Dispense [PRE-ORDER]',
        type: 'physical',
        price: 12,
        status: 'available',
        composition: '2.5-inch figure, prescription-style container, compound assigned at random from current batch',
        notes: 'FIRST EDITION PRE-ORDER — Limited to 250 units. Each dose contains one randomly assigned compound from the current batch. Contents remain unknown until opened. Current batch may include black, blue, pink, white/orange, and hand-painted variants. Outcomes are not selectable and probability is not uniform.',
        administrationMethod: 'Pre-order ends June 13. Orders will be shipped by June 20.',
  ...
  {
    id: 'DSG-OS',
    name: 'Dosage — Open Selection [PRE-ORDER]',
    description: 'FIRST EDITION PRE-ORDER — Limited to 250 units. Select a specific compound from the current index. Each dose contains one standard issue (black) figure. Color and painted variants are not distributed through this method. Pre-order ends June 13. Orders will be shipped by June 20.',
    classification: 'Dose (2.5" Figure)',
    format: 'standard',
    status: 'active',
    doses: [
      {
        id: 'd-open',
        productId: 'DSG-OS',
        title: 'Open Selection [PRE-ORDER]',
        type: 'physical',
        price: 20,
        status: 'available',
        composition: '2.5-inch figure, prescription-style container, compound selected from current batch',
        notes: 'FIRST EDITION PRE-ORDER — Limited to 250 units. Select a specific compound from the current index. Each dose contains one standard issue (black) figure. Color and painted variants are not distributed through this method.',
        administrationMethod: 'Pre-order ends June 13. Orders will be shipped by June 20.',
        options: {
          name: 'Selection',
